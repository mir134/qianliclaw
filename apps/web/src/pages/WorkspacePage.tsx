    ...
    <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {isCustomPath && (
            <button
              ...
              disabled={savingSettings}
              className="px-5 py-2.5 rounded-xl border-2 border-neutral-200 dark:border-slate-700 px-5 py-2.5 text-sm font-medium text-neutral-600 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-slate-700 disabled:opacity-50 transition-all duration-200"
            >
              重置
            </button>
          )}
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        <div className="w-full shrink-0 lg:w-[450px] lg:min-w-[450px]">
          <div className="bg-white/70.7 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 dark:border-white/10 h-[550px] flex flex-col">
        ...
        <div className="min-w-0 flex-1 space-y-4">
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-white/20 dark:border-white/10">
            ...
            <div className="rounded-xl bg-white/50 dark:bg-slate-900/50 p-4 shadow-inner border border-neutral-200 dark:border-neutral-700">
              ...
              {contentLoading ? (
                <div className="flex items-center justify-center h h-64">
